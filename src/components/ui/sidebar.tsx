...
const SIDEBAR_WIDTH_MOBILE = "min(calc(100vw - 3rem), 18rem)"
...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      variant="outline"
      size="icon"
      className={cn("h-8 w-8 transition-none border-primary/20 text-primary hover:bg-primary hover:text-white", className)}
      onClick={(event) => {
        onClick?.(event)
        toggleSidebar()
      }}
